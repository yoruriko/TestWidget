...
public class PullToRefreshView extends ViewGroup {
    ...
    public static final int STYLE_ROAR = 0;
    ...
    public PullToRefreshView(Context context, AttributeSet attrs) {
        ...
        final int type = a.getInteger(R.styleable.RefreshView_type, STYLE_ROAR);
        a.recycle();
    ...
    public void setRefreshStyle(int type) {
        ...
        switch (type) {
            case STYLE_ROAR:
                mBaseRefreshView = new RoarRefreshView(getContext(), this);
                break;
            default:
