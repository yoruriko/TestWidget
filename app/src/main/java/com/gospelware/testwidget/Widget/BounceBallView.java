...
public class BounceBallView extends View {
    ...
    private static float MAX_STRETCH = 30;
    ...
    class VPoint {
        ...
        public void setX(float x, float offset) {
            this.x = x;
            left.x = x - offset;
            right.x = x + offset;
        }
    ...
    class HPoint {
        ...
        public void setY(float y, float offset) {
            this.y = y;
            top.y = y - offset;
            bottom.y = y + offset;
        }
    ...
    public void state1(float time) {// Between 0.0~0.8  Interpolate Time
    ...
    public void state2(float time) {// Between 0.8~1.0 Interpolate Time
